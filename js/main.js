...
import { Wave, Mark } from './Visualiser.js';
...
class RippleBeat {
    ...
    bindEvents() {
        ...
        this.resetBtn.addEventListener('click', () => {
            this.marks = [];
            this.notification.style.opacity = '0';
            this.wave.setWaveColour('#2c1a12');
    ...
    resize() {
        ...
        this.pivot.y = window.innerHeight * 0.65;
    ...
    handleInteraction(e) {
        ...
        let normalisedPos = (exactAngleAtTap / this.MAX_ANGLE + 1) / 2;
        let splashX = normalisedPos * window.innerWidth;
        this.wave.addRipple(splashX, -50);
        this.wave.setWaveColour(mark.colour); 
    }
